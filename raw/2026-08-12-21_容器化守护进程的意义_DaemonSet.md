...
而如果你使用 kubectl describe 查看这个 ControllerRevision 对象：
    ...
    Annotations:  deprecated.daemonset.template.generation=2
                  kubernetes.io/change-cause=kubectl set image ds/fluentd-elasticsearch fluentd-elasticsearch=k8s.gcr.io/fluentd-elasticsearch:v2.2.0 
    API Version:  apps/v1
    Data:
      Spec:
        Template:
...
接下来，我们可以尝试将这个 DaemonSet 回滚到 Revision=1 时的状态：
    ...
    $ kubectl rollout undo daemonset fluentd-elasticsearch 
